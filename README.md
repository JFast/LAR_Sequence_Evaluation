...
Required packages/libraries: *OpenCV 4*, *NumPy*, *SciPy*, *SymPy*, *Matplotlib*.
...
Versions of packages/libraries used in this study: *opencv-python 4.5.2.52*, *numpy 1.20.2*, *scipy 1.6.2*, *sympy 1.8*, *matplotlib 3.4.1*.
